<template>
  <li class="sm:grid grid-cols-10 gap-4">
    <div class="order-1 col-span-2 flex items-center justify-center">
      ...
      <span v-else-if="isCurrentDay" class="block font-bold">{{ timer.hours }}:{{ timer.minutes }}:{{ timer.seconds }}</span>
