<template>
  <div class="flex items-center">
    ...
    <button
      ...
      class="w-full inline-flex items-center justify-center border border-transparent font-medium rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-offset-1 transition-hover-300"
    >
     {{ props.submitText }}
    </button>
    <button
      ...
      class="w-full inline-flex items-center justify-center border border-transparent font-medium rounded-md shadow-sm"
    >
     {{ props.submitText }}
    </button>
