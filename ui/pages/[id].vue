<template>
  <ContainerNarrow class="py-20">
    ...
    <div v-if="!riddle?.isSolved" class="mt-6">
      <h2 class="font-medium">Riddle</h2>
      <div class="text-gray-600 prose max-w-none" v-html="riddle?.riddle"></div>
    </div>

    <div v-if="riddle?.isSolved" class="mt-8">
      <div>
        ...
        <div class="mt-6 text-gray-500 prose max-w-none italic" v-html="riddle?.solvedText"></div>
      </div> 
    </div>
